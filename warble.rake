...
task :war do 
  ...
  sh 'unzip wex-appbuilder-sample-proxy.war "WEB-INF/lib/jruby-stdlib-*.jar"'
  ...
  jars_to_shimmy.each do |jar|
    ...
    sh "zip wex-appbuilder-sample-proxy.war WEB-INF/lib/#{jar}.jar"
    # sh "jar -uf wex-appbuilder-sample-proxy.war WEB-INF/lib/#{jar}.jar"
  end
